<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountSetting.aspx.cs" Inherits="AccountSetting" %>
...
<body>
    <section class="login">
	<div class="titulo">Account Setting</div>
	<form action="#" method="post" enctype="application/x-www-form-urlencoded">
    	<input type="text" required title="Hi Customer required" readonly placeholder="Hi Customer" data-icon="U">
    	<asp:Image ID="Image1" runat="server" Height="127px" 
            ImageUrl="~/images/389384_587446061288109_1514765693_n.jpg" Width="241px" />
        <div class="olvido">
        	<div class="col"><a href="MyAlbums.aspx" title="Ver Carásteres">My Albums</a></div>
            <div class="col"><a href="ChangeInformation.aspx" title="Recuperar Password" dir="ltr">Change Information</a></div>
             <div class="col"><a href="ChangePassword.aspx" title="Recuperar Password" dir="ltr">Change Password</a></div>
              <div class="col"><a href="ChangeAvatar.aspx" title="Recuperar Password" dir="ltr">Change Avatar</a></div>
               <div class="col"><a href="Logout.aspx" title="Recuperar Password" dir="ltr">Logout</a></div>
        </div>
    </form>
</section>
</body>
