...
<body>
        <section class="login">
	<div class="titulo">REGISTERED PARTCIPANTS DPP STORE</div>
	<form action="#" method="post" enctype="application/x-www-form-urlencoded">
    	<input type="text" required title="Username required" placeholder="Username " data-icon="U">
    	<input type="text" required title="Fullname required" placeholder="Full name" data-icon="U">
    	<input type="password" required title="Password required" placeholder="Password" data-icon="x">
    	<input type="password" required title="Confirm Password required" placeholder="Confirm Password" data-icon="x">
    	<input type="text" required title="Birthday required" placeholder=Birthday " data-icon="U">
    	<input type="text" required title="Phone required" placeholder=Phone " data-icon="U">
    	<input type="text" required title="Email required" placeholder=Email " data-icon="U">
    	<input type="text" required title="Address required" placeholder=Address " data-icon="U">
    	<input type="text" required title="National required" placeholder=National " data-icon="U">
        <div class="olvido"<div class="col">
        
        </div>
        <a href="Login.aspx" class="enviar">REGISTER</a>
    </form>
</section>
</body>
</html>
