...
<body>
	...
	<form action="#" method="post" enctype="application/x-www-form-urlencoded">
    	<input type="text" required title="Old Password required" placeholder="Old Password" data-icon="U">
        <input type="text" required title="New Password required" placeholder="New Password" data-icon="x">
        <input type="text" required title="Confim Your New Password required" placeholder="Confirm Your Password" data-icon="x">
        <div class="olvido">
