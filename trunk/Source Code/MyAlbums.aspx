...
<body>
     <section class="login">
	<div class="titulo">ALL ALBUMS</div>
	<form action="#" method="post" enctype="application/x-www-form-urlencoded">
	       <a href="#" class="enviar">Create a new albums</a>
    	<input type="text" required title="Username required" readonly placeholder="" data-icon="U">
        <div class="olvido">        	
        </div> 
        <a href="#" class="enviar">Add Image</a>
        <a href="#" class="enviar">Edit Image</a>
        <a href="#" class="enviar">Delete Image</a>
    </form>
</section>
</body>
</html>
