<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Tes" StyleSheetTheme="" %>
...
<body>
	...
	<form action="#" method="post" enctype="application/x-www-form-urlencoded">
        ...
        <div class="olvido">
        	<div class="col"><a href="Register.aspx" title="Ver Carásteres">Register</a></div>
            <div class="col"><a href="ChangePassword.aspx" title="Recuperar Password" dir="ltr">Fotgot Password?</a></div>
        </div>
