...
<body>
    <section class="login">
	<div class="titulo">UPLOAD IMAGE</div>
	<form id="form1" runat="server">
    	<a href="#" class="enviar">Create a new albums</a>
    	<input type="text" required title="Username required" readonly placeholder="" data-icon="U"><asp:FileUpload 
        ID="FileUpload1" runat="server" />
&nbsp;<div class="olvido">
        </div>
        <a href="#" class="enviar">UPLOAD</a>
    </form>
</section>
</body>
</html>
