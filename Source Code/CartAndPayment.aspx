<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CartAndPayment.aspx.cs" Inherits="Cart" %>
...
<body>
    <section class="login">
	<div class="titulo">CART AND PAYMENT</div>
	<form id="form1" runat="server">
    	<input type="text" required title="Wash applied to image cart required" readonly placeholder="Wash applied to image cart" data-icon="U">
        <input type="text" required title="Size" readonly placeholder="Size" data-icon="U"><asp:DropDownList 
        ID="ddlSize" runat="server" Font-Bold="True" Height="21px" Width="245px">
    ...
    <input type="text" required title="Quantity" readonly placeholder="Quantity" data-icon="U">
&nbsp;
<asp:DropDownList 
        ID="DropDownList1" runat="server" Font-Bold="True" Height="21px" Width="245px">
        ...
        <a href="#" class="enviar">Apply</a>
    </form>
    <form action="#" method="post" enctype="application/x-www-form-urlencoded">
    	<input type="text" required title="Total required" placeholder="Total" data-icon="U">
        <input type="text" required title="Sales (0%) required" placeholder="Sales (0%)" data-icon="U">
        <input type="text" required title="Into Money required" placeholder="Into Money" data-icon="U">
        <div class="olvido">
        </div>
        <a href="#" class="enviar">Payment</a>
    </form>
</section>
</body>
</html>
