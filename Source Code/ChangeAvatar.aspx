<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeAvatar.aspx.cs" Inherits="ChangeAvatar" %>
...
<body>
    <section class="login">
	<div class="titulo">CHANGE AVATAR</div>
	<form id="form1" runat="server">
    	<input type="text" required title="Current Avatar required" readonly placeholder="Current Avatar" data-icon="U">
        <asp:Image ID="Image1" runat="server" Height="127px" 
            ImageUrl="~/images/389384_587446061288109_1514765693_n.jpg" Width="241px" />
        <input type="text" required title="Upload New Avatar required" readonly placeholder="Upload New Avatar" data-icon="x">
